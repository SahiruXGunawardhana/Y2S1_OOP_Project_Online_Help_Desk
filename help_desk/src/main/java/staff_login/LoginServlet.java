    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (staffLogin != null && !staffLogin.isEmpty()) {
                ...
                // If you have these fields in your staffModel, uncomment them
                // session.setAttribute("profileImage", staff.getProfileImage());
                // session.setAttribute("joinDate", staff.getJoinDate());

                // Redirect to Staff Dashboard instead of profileServlet
            ...
            e.printStackTrace();
            response.getWriter().println("<script>alert('Something went wrong.'); window.location.href='login.jsp';</script>");
        }
    }
}