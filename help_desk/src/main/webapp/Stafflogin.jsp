...
<head>
  ...
  <title>University Help Desk Login</title>
...
<body class="bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen flex items-center justify-center font-sans">
  <div class="w-full max-w-md bg-white shadow-2xl rounded-2xl p-8">
    ...
    <div class="text-center mb-6">
      <h1 class="text-2xl font-bold text-blue-800">University Help Desk</h1>
      <p class="text-sm text-gray-600">Staff Login Portal</p>
    </div>
