    ...
    <div class="card max-w-4xl mx-auto">
        ...
        <div class="border-b border-gray-200 pb-4 mb-6">
            <h2 class="text-2xl font-bold text-gray-800" style="display: flex; align-items: center;">
                <i class="fas fa-file-alt mr-3" style="color: #3498db;"></i>
                Add New Article
            </h2>
            <p class="text-gray-600 mt-2">Create and publish a new help desk knowledge base article</p>
        </div>

        <!-- Form -->
        <form id="articleForm" action="InsertArticleServlet" method="post" class="space-y-6">
            <!-- Title Field -->
