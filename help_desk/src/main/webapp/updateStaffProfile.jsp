    ...
    <main class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-md">
        <div class="flex flex-col items-center space-y-6">
            ...
            <div class="w-32 h-32 rounded-full overflow-hidden shadow-md">
                <img src="profileUploads/<%= image %>" alt="Profile Image" class="w-full h-full object-cover" />
            </div>
            ...
            <form action="UpdateStaffProfileServlet" method="post" enctype="multipart/form-data" class="w-full space-y-6">
                ...
                <!-- Image Upload -->
                <div>
                    <label class="block text-gray-700 font-semibold mb-2" for="image">Change Profile Image</label>
                    <input type="file" id="image" name="image"
                        class="w-full border px-4 py-2 rounded-md file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" />
                </div>
